          ...
          <CardContent>
            ...
            <List className={classes.list}>
              <ListItem key={0} button>
                <ListItemText primary={<Furigana furigana="くに:しきべつ" opacity={1.0}>国を識別しよう</Furigana>} />
              ...
              <ListItem key={1} button>
                <ListItemText primary={<Furigana furigana="ちず:くに:み" opacity={1.0}>地図に国を見つけりよう</Furigana>} />
                <ListItemSecondaryAction>
                  <Checkbox
                    edge="end"
              ...
              <ListItem key={2} button>
                <ListItemText primary={<Furigana furigana="しゅと:しきべつ" opacity={1.0}>首都を識別しよう</Furigana>} />
                <ListItemSecondaryAction>
                  <Checkbox
                    edge="end"
              ...
              <ListItem key={3} button>
                <ListItemText primary={<Furigana furigana="くに:しゅと:あ" opacity={1.0}>国と首都を合わせりよう</Furigana>} />
                <ListItemSecondaryAction>
                  <Checkbox
                    edge="end"
              ...
              <ListItem key={4} button>
                <ListItemText primary={<Furigana furigana="くに:はた:あ" opacity={1.0}>国と旗を合わせりよう</Furigana>} />
                <ListItemSecondaryAction>
                  <Checkbox
                    edge="end"
